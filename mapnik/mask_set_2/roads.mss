...
.ne_10m_z6_roads[zoom=6][roadtype="Beltway"],
.ne_10m_z6_roads[zoom=6][scalerank<=5][type_2="Expressway"]
{
	line-width: 3.8;
    line-color: #f00;
}
...
.ne_10m_z7_roads_casing[zoom=7][roadtype="Beltway"],
.ne_10m_z7_roads_casing[zoom=7][scalerank<=5][type_2="Expressway"]
{
	line-width: 6;
    line-color: #000;
}
...
.ne_10m_z7_roads_casing[zoom=8][scalerank=3],
.ne_10m_z7_roads_casing[zoom=8][scalerank=4],
.ne_10m_z7_roads_casing[zoom=8][roadtype="Beltway"],
.ne_10m_z7_roads_casing[zoom=8][scalerank<=6][type_2="Expressway"]
{
	line-width: 6;
    line-color: #000;
}
